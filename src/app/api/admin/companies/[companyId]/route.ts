...
export async function PATCH(
  ...
  try {
    ...
    if (activePlan !== undefined) {
      const validPlans = ["Free", "company-pro", "company-pro+", "Enterprise"];
    ...
    // 6. Connect to DB and update company profile
    ...
    console.error("PATCH /api/admin/companies/[companyId] error:", err);
